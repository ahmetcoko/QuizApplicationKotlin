...
import com.example.quizapplication.databinding.ViewholderLeaderBinding
import com.example.quizapplication.databinding.ViewholderQuestionBinding
...
class QuestionAdapter(val correctAnswer: String, val users:MutableList<String> = mutableListOf(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionAdapter.ViewHolder {
        ...
        val itemBinding = ViewholderQuestionBinding.inflate(inflater, parent, false)
